<template>
  ...
  >
    ...
    <p class="mb-8 leading-relaxed text-zinc-600 md:mb-2 lg:w-full xl:text-lg">
      Obtenha uma avaliação personalizado sobre o seu currículo com o uso de
    ...
    >
      ...
      <p>
        O sucesso não é definitivo, o fracasso não é fatal: o que importa é a
        coragem de continuar - Winston Churchill
      </p>
    </blockquote>
  </div>
</template>
